...
def create_projectile(player, power):
    if player == 1:
        if power == "fireball":
            ...
            player1_projectiles.append([player1_x + player1_width, player1_y + player1_height // 2, GREEN])
    elif player == 2:
        if power == "lightning":
            ...
            player2_projectiles.append([player2_x, player2_y + player2_height // 2, PURPLE])
...
while running:
    for event in pygame.event.get():
        ...
        if event.type == pygame.KEYDOWN:
            ...
            if event.key == pygame.K_3: #player 1 power change
                player1_power = "poison"
            if event.key == pygame.K_4: #player 2 power change
                player2_power = "lightning"
            if event.key == pygame.K_5: #player 2 power change
                player2_power = "rock"
            if event.key == pygame.K_6: #player 2 power change
                player2_power = "magic"
    ...
    pygame.draw.circle(screen, BLUE, (player1_x + player1_width // 2, player1_y - player1_head_radius), player1_head_radius)
    pygame.draw.rect(screen, RED, (player2_x, player2_y, player2_width, player2_height))
    pygame.draw.circle(screen, RED, (player2_x + player2_width // 2, player2_y - player2_head_radius), player2_head_radius)
