...
while running:
    ...
    # Health bars
    pygame.draw.rect(screen, BLACK, (50, 20, 200, 20)) #player 1 outline
    pygame.draw.rect(screen, GREEN, (50, 20, player1_health * 2, 20)) #player 1 health
    player1_text = font.render("Player 1", True, BLACK)
    screen.blit(player1_text, (50, 45))

    pygame.draw.rect(screen, BLACK, (WIDTH - 250, 20, 200, 20)) #player 2 outline
    pygame.draw.rect(screen, GREEN, (WIDTH - 250, 20, player2_health * 2, 20)) #player 2 health
